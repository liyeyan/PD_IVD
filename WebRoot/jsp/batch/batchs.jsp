  ...
  <body>
	<form action="batch.html" method="post" name="batchForm" id="batchForm">
	    ...
	    <div class="tools">
	    	...
	    	<ul class="seachform" style="margin-left:32px;">
	    ...
	    <table class="tablelist" style="margin-left:32px;width: 800px">
	    	<thead>
	    	<tr>
		        <th width="50px">编号</th>
		        <th width="300px">批次号</th>
	        ...
	        <c:choose>
				<c:when test="${not empty batchList}">
					...
					<td align="left">
			        	<a href="#" class="tablelink" onclick="window.location.href='sample/detailList.html?batchId=${batch.batchId}'">查看详情</a><label>&nbsp;</label>
						&nbsp;&nbsp;<a href="#" class="tablelink" onclick="doDel(${batch.batchId })"> 删除</a>
			        </td>
